...
def get_wide_sales(
    ...
    :param sales_master: Master DataFramesfor Sales.
    :param calendar_master: Master DataFramesfor Calendar.
    :param customer_master: Master DataFramesfor Customer.
    :param products_master: Master DataFramesfor Products.
    :param product_subcategory_master: Master DataFramesfor Product Subcategory.
    :param product_category_master: Master DataFramesfor Product Category.
    :return: The joined DataFramewith the additional columns.
    """
